...
const handleToggleLike = async () => {
  ...
  const isNew =
    new Date(food.CreatedAt || "").getTime() > Date.now() - 10 * 60 * 1000;
  ...
  const getDifficultyFromCalories = (calories?: number) => {
    if (!calories)
      return { color: "bg-gray-100 text-gray-800", text: "ไมได้รับพลังงาน" };
    if (calories < 300)
      return { color: "bg-green-100 text-green-800", text: "พลังงานน้อย" };
    if (calories < 500)
      return { color: "bg-yellow-100 text-yellow-800", text: "พลังงานปานกลาง" };
      ...
      <div className="p-4">
        ...
        {food.Ranking && (
          <div className="flex items-center text-gray-600 text-sm mb-4">
            ...
            <span>
              อันดับ {food.Ranking.Rank} - {food.Ranking.Detail}
            </span>
          </div>
        )}
        ...
        <div className="flex flex-wrap items-center justify-start gap-2 mt-3 mb-2">
          ...
          <span
            className={`px-3 py-1 rounded-full text-xs font-medium ${difficultyConfig.color}`}
          >
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex flex-col">
              <span className="text-lg font-bold text-gray-700 ml-8">
